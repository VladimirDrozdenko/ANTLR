...
public class PropertyFileParser extends Parser {
	...
	public static class FileContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PropertyFileLoader) ((PropertyFileLoader)listener).enterFile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PropertyFileLoader) ((PropertyFileLoader)listener).exitFile(this);
		}
		@Override
	...
	public static class PropsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PropertyFileLoader) ((PropertyFileLoader)listener).enterProps(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PropertyFileLoader) ((PropertyFileLoader)listener).exitProps(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PropertyFileVisitor ) return ((PropertyFileVisitor<? extends T>)visitor).visitProps(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final PropsContext props() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_props);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
