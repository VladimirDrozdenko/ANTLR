...
public interface PropertyFileListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PropertyFileParser#props}.
	 * @param ctx the parse tree
	 */
	void enterProps(PropertyFileParser.PropsContext ctx);
	/**
	 * Exit a parse tree produced by {@link PropertyFileParser#props}.
	 * @param ctx the parse tree
	 */
	void exitProps(PropertyFileParser.PropsContext ctx);
}