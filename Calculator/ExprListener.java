...
public interface ExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ExprParser#clr}.
	 * @param ctx the parse tree
	 */
	void enterClr(ExprParser.ClrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ExprParser#clr}.
	 * @param ctx the parse tree
	 */
	void exitClr(ExprParser.ClrContext ctx);
}